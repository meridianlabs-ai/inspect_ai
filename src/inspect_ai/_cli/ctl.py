...
The old flat spellings survived as hidden, deprecation-noted aliases for a
transition window and have since been removed; the old ``sample`` command's
name is claimed by the group, and its error message points at
``sample show``.
"""
